...
This is a remake of my first-ever solo app which I built in 2013 in Java using the Java Swing API. I used Next.js, React, Motion and TypeScript for this remake. Along the way, I applied best practices from the [React documentation][2] and the book [A Philosophy of Software Design][3]. I have noted a few of them below.
