...
![Screenshot showing an information rendered like a button](/usability-wrong-affordance.png "Incorrect Affordance")
...
![Screenshot showing information rendered as text next to an icon](/usability-right-affordance.png "Correct Affordance")
